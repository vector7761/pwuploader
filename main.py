...
AUTH_USER = os.environ.get('AUTH_USERS', '1226915008,7341059064,8144269730,6440249117,614886582,5817712634,7615363859,1511257208,5486913681,761536385,7080838404').split(',')
